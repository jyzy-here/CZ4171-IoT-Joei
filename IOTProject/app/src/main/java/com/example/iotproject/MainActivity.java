    ...
    private void dispatchPictureTakerAction() {
        ...
        if (takePic.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                displayMessage(getApplicationContext(), "Null");
            }
            ...
            if (photoFile != null) {
                ...
                Uri photoURI = FileProvider.getUriForFile(this, "com.example.iotproject.fileprovider", photoFile);

                takePic.putExtra(MediaStore.EXTRA_OUTPUT, photoURI);
                Log.d("test", photoURI.toString());
